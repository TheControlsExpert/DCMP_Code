...
public class ThirdPartAutoAlignAlgae extends Command {
    Drive drive;
    ...
    public ThirdPartAutoAlignAlgae(Drive drive, VisionSubsystem vision, Superstructure superstructure) { //SwerveDriveOdometry odometryRelative) {
        this.drive = drive;
        this.vision = vision;
    ...
    public boolean isFinished() {
        ...
        return  Math.hypot(offsetX, offsetY) < 0.01;
    }
